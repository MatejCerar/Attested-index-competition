...
Nothing in `scripts/server.mjs`, the engines, or `scripts/rebalancer.mjs` is
...
| `extension/build-index.ts` | The canonical deterministic index builder, pinned at the integer-bps boundary. |
